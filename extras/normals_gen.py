...
model_cache_dir = "/fsx/ubuntu/3d_model_finetuning/InstantMesh/ckpts"
...
cond = Image.open("/fsx/ubuntu/3d_model_finetuning/InstantMesh/data/custom/rendering_zero123plus/7up-short/000.png")
...
genimg.save("/fsx/ubuntu/3d_model_finetuning/InstantMesh/extras/outputs/colors.png")
normalimg.save("/fsx/ubuntu/3d_model_finetuning/InstantMesh/extras/outputs/normals.png")
