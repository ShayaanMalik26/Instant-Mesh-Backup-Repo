...
parser.add_argument("-f", "--file", type=str,
                    default="/fsx/ubuntu/3d_model_finetuning/InstantMesh/logs/zero123plus-finetune/checkpoints/last.ckpt", help="path to model")
...
parser.add_argument("-st", "--safe-tensors", default=True,  action="store_true",
                    help="use safetensors model format")
