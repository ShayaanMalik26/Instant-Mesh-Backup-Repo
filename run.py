...
parser.add_argument('--config', default="configs/instant-nerf-large.yaml", type=str, help='Path to config file.')
parser.add_argument('--input_path', default="/fsx/ubuntu/3d_model_finetuning/InstantMesh/data/custom/rendering_zero123plus/lion/023.png",
                    type=str, help='Path to input image or directory.')
